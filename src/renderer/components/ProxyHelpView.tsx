...
const ProxyHelpView: FC = () => {
  ...
  return (
    <div className="p-10 text-white h-screen box-border overflow-y-auto bg-[#1e1e1e] font-sans">
      <h1 className="border-b border-zinc-700 pb-4 mt-0">
        🌐 Proxy Network 構築ガイド
      </h1>
      ...
      <div className="bg-[#252526] rounded-lg px-5 pt-6 pb-5 mb-6 border border-[#3e3e42] relative shadow-md">
        <div className="absolute -top-3 left-5 bg-accent text-white px-3 py-1 rounded-xl text-sm font-bold shadow-md">Step 1</div>
        <h3>GUIでの基本設定</h3>
      ...
      {/* --- Step 2 --- */}
      <div className="bg-[#252526] rounded-lg px-5 pt-6 pb-5 mb-6 border border-[#3e3e42] relative shadow-md">
        <div className="absolute -top-3 left-5 bg-accent text-white px-3 py-1 rounded-xl text-sm font-bold shadow-md">Step 2</div>
        <h3>サーバーファイルの配置</h3>
        <p>
        ...
        <div className="mb-4">
          ...
          <span className="text-zinc-300 text-[0.95rem]">"Files"タブの「移動」ボタンなどを使い、以下のパスへ移動します。</span>
      ...
      {/* --- Step 3 --- */}
      <div className="bg-[#252526] rounded-lg px-5 pt-6 pb-5 mb-6 border border-[#3e3e42] relative shadow-md">
        <div className="absolute -top-3 left-5 bg-accent text-white px-3 py-1 rounded-xl text-sm font-bold shadow-md">Step 3</div>
        <h3>設定ファイルの編集と完了</h3>
