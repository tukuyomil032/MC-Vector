  ...
  return (
    <div className="p-10 text-white h-screen box-border overflow-y-auto bg-[#1e1e1e]">
      ...
      <div className="bg-[#252526] rounded-lg p-5 mb-5 border border-[#3e3e42] relative">
        <div className="absolute -top-2.5 left-5 bg-accent px-2.5 py-0.5 rounded-xl text-xs font-bold">Step 1</div>
        <h3>公式サイトへアクセス</h3>
      ...
      <div className="bg-[#252526] rounded-lg p-5 mb-5 border border-[#3e3e42] relative">
        <div className="absolute -top-2.5 left-5 bg-accent px-2.5 py-0.5 rounded-xl text-xs font-bold">Step 2</div>
      ...
      <div className="bg-[#252526] rounded-lg p-5 mb-5 border border-[#3e3e42] relative">
        <div className="absolute -top-2.5 left-5 bg-accent px-2.5 py-0.5 rounded-xl text-xs font-bold">Step 3</div>
        <h3>アプリに入力して接続</h3>
        <p>
