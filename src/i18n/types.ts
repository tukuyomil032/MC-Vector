...
export interface TranslationDictionary {
  ...
  backups: {
    ...
    toast: {
      ...
      diffCreated: string;
      created: string;
      createMetadataSaveFailed: string;
      createFailed: string;
      invalidNameEmpty: string;
      invalidNameCharacters: string;
      restored: string;
      restoreFailed: string;
      deleteMetadataSaveFailed: string;
      deleted: string;
      deleteFailed: string;
      retentionDeleteFailed: string;
      retentionListFailed: string;
      retentionMetadataSaveFailed: string;
      tagSaved: string;
  ...
  map: {
    ...
    management: {
      ...
      coreReleaseTag: string;
      coreVerification: string;
      coreDownloadRequired: string;
      coreDownloading: string;
      coreVerifying: string;
      coreInstalled: string;
      coreError: string;
      coreRetry: string;
      coreProvenanceDevelopment: string;
      coreProvenanceBundled: string;
      coreProvenanceGithubRelease: string;
