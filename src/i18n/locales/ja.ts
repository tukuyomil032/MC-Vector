...
export const ja: TranslationDictionary = {
  ...
  settings: {
    ...
    security: {
      title: 'セキュリティ',
      description: 'プラグインのダウンロード検証に関する設定です。',
      label: '未検証のプラグインダウンロードを許可する',
      warning:
        '警告：有効にすると、検証されていないプラグインのダウンロードを許可します。リスクを理解し、受け入れられる場合だけ有効にしてください。',
      saving: 'セキュリティ設定を保存中...',
      saveError: 'この設定を保存できなかったため、変更を元に戻しました。',
    },
    general: {
      title: '一般',
    },
  ...
  map: {
    ...
    tabMap: '地図',
    tabManagement: '管理',
    setupTitle: 'Map機能を有効にしますか？',
    setupDescription:
      'MC-Vector CoreをPaperサーバーのpluginsフォルダへ配置し、同じマシン上のMC-Vectorへプレイヤー情報と変更通知を渡します。外部公開用のWebサーバーは起動しません。',
    setupEnable: 'Mapを有効にする',
    setupSkip: '今回は使わない',
    featureTitle: 'MC-Vector Map',
    featureDescription:
      'Dynmapに近い地図表示を、サーバーごとのオプトイン機能として提供します。初回導入や更新では再起動が必要になる場合があります。',
    enabled: '有効',
    disabled: '無効',
    status: {
      absent: '未導入',
    ...
    bridge: {
      ...
      incompatible: '互換性なし',
      error: 'エラー',
      statusError: 'ブリッジ設定を確認できません',
      statusErrorDescription:
        '設定状態を取得できないため、地図タイルの取得を停止しています。管理画面から再試行してください。',
      configurationRequired: 'ブリッジ設定の修復が必要です',
      configurationRequiredDescription:
        'ブリッジ設定が古いか不正です。修復後、必要に応じてPaperサーバーを再起動してください。',
      repair: '設定を修復',
    },
    actions: {
      enable: '有効化',
      ...
      zoomIn: '拡大',
      zoomOut: '縮小',
      openSettings: '全般設定を開く',
      confirmRemove: '完全削除する',
      cancel: 'キャンセル',
    },
    asset: {
      title: 'Minecraft資産',
    ...
    surface: {
      overworld: 'Overworld',
      loading: '地図状態を読み込み中…',
      placeholder: 'Mapコンポーネントを有効にしてください',
      notAvailable: 'PaperサーバーとMapコンポーネントを確認してください',
      loadingTiles: '地形タイルを生成中です',
      noTile: '地形タイルがまだありません',
      noTileDescription: '表示範囲のチャンクを読み込むと、ここへ実際の地図が表示されます。',
      noGeneratedTerrain: 'この範囲には生成済み地形がありません',
    ...
    management: {
      ...
      componentDescription:
        'サーバー側では通常のPaperプラグインとして読み込まれます。MC-VectorのPluginBrowserでは管理対象として分離されます。',
      componentName: '管理コンポーネント',
      managed: 'MC-Vector管理',
      paperPluginNote:
        'Paper側の /plugins では通常のプラグインとして表示されます。PluginManagerを改変して隠すことはありません。',
      version: 'プラグインバージョン',
      protocol: 'プロトコル',
      port: 'ローカルポート',
      lastHeartbeat: '最終ハートビート',
      noHeartbeat: 'まだ受信していません',
      configState: '設定状態',
      configReason: '診断コード',
      coreState: 'Core artifact状態',
      coreVersion: 'Coreバージョン',
      coreProvenance: '配布元',
      coreReleaseTag: 'Release tag',
      coreVerification: '検証状態',
      coreDownloadRequired: '対応するCore artifactを取得する必要があります。',
      coreDownloading: 'Core artifactをダウンロード中…',
      coreVerifying: 'manifest・hash・plugin identityを検証中…',
      coreInstalled: '検証済みCore artifactをインストール済みです。',
      coreError: 'Core artifactを検証・インストールできませんでした。再試行してください。',
      coreRetry: 'Coreを再試行',
      coreProvenanceDevelopment: 'Development',
      coreProvenanceBundled: 'Bundled',
      coreProvenanceGithubRelease: 'GitHub Release',
      restartRequired: '変更を完全に反映するにはサーバーの再起動が必要です。',
      artifactMissing:
        'MinecraftクライアントJARとは別に、検証済みのMC-Vector Core artifactが必要です。取得に失敗した場合は再試行してください。',
      pausedDescription: 'Coreは一時停止中です。再有効化すると次回起動時に読み込まれます。',
      removalDescription:
        'サーバー停止後に管理対象ファイルを削除できます。サーバーは自動停止しません。',
      conflictDescription:
        '同名のファイルをMC-Vector管理物と確認できません。上書き・名前変更・削除は行っていません。',
      removeConfirmTitle: 'Mapコンポーネントを完全削除しますか？',
    ...
    toast: {
      ...
      restored: 'Map機能を再有効化しました',
      removePending: 'サーバー停止後にMapコンポーネントを削除します',
      removed: 'Mapコンポーネントを削除しました',
