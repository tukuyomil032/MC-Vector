...
export const en: TranslationDictionary = {
  ...
  map: {
    ...
    management: {
      ...
      artifactMissing:
        'The managed bridge configuration is ready, but the MC-Vector Core distribution JAR is not bundled yet. Complete the Core artifact build and packaging before using this with a real server.',
      pausedDescription:
