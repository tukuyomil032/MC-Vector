 ...
 * Ported-to: src-tauri/src/map/renderer/dynmap/mod.rs
 * Changes: Kept only the source-derived geometry module boundary; no Dynmap
 *          runtime or Bukkit integration is included.
 */
