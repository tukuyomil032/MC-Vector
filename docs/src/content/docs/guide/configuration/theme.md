...
description: Customize the MC-Vector interface appearance.
sidebar:
  order: 3
---
...
1. Click **"Check for Updates"** to query the latest release.
2. If an update is available, click **"Download"** — progress is shown in real-time.
