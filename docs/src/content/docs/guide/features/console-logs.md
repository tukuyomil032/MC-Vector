---
title: Console & Logs
description: Stream real-time server logs and send commands from the MC-Vector console.
sidebar:
  order: 2
---
...
:::caution
Do **not** prefix commands with `/` in the Console. The server console accepts bare commands, not slash commands.
:::
