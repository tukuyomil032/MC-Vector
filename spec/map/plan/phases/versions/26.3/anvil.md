# V-26.3-anvil: 26.3 saved Anvil adapter
...
```bash
bun scripts/run-map-version-phase.mjs --version 26.3 --phase anvil
bun scripts/check-map-version-phase.mjs --version 26.3 --phase anvil --require-evidence
```
...
```text
feat: add minecraft 26.3 anvil adapter
```
