# V-26.3-assets: 26.3 official assets
...
```bash
bun scripts/run-map-version-phase.mjs --version 26.3 --phase assets
bun scripts/check-map-version-phase.mjs --version 26.3 --phase assets --require-evidence
```
...
```text
feat: add minecraft 26.3 asset profile
```
