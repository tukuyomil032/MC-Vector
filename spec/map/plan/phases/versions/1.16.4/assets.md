# V-1.16.4-assets: 1.16.4 official assets
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.16.4 --phase assets
bun scripts/check-map-version-phase.mjs --version 1.16.4 --phase assets --require-evidence
```
...
```text
feat: add minecraft 1.16.4 asset profile
```
