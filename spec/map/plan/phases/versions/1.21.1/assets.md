# V-1.21.1-assets: 1.21.1 official assets
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.21.1 --phase assets
bun scripts/check-map-version-phase.mjs --version 1.21.1 --phase assets --require-evidence
```
...
```text
feat: add minecraft 1.21.1 asset profile
```
