# V-1.21-paper-snapshot: 1.21 Paper snapshot adapter
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.21 --phase paper-snapshot
bun scripts/check-map-version-phase.mjs --version 1.21 --phase paper-snapshot --require-evidence
```
...
```text
feat: add paper snapshot adapter for minecraft 1.21
```
