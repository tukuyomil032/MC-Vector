# V-1.19.1-reference-and-parity: 1.19.1 Java reference and pixel parity
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.19.1 --phase reference-and-parity
bun scripts/check-map-version-phase.mjs --version 1.19.1 --phase reference-and-parity --require-evidence
```
...
```text
test: verify dynmap parity for minecraft 1.19.1
```
