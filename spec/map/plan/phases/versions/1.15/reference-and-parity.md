# V-1.15-reference-and-parity: 1.15 Java reference and pixel parity
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.15 --phase reference-and-parity
bun scripts/check-map-version-phase.mjs --version 1.15 --phase reference-and-parity --require-evidence
```
...
```text
test: verify dynmap parity for minecraft 1.15
```
