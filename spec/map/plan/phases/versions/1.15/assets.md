# V-1.15-assets: 1.15 official assets
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.15 --phase assets
bun scripts/check-map-version-phase.mjs --version 1.15 --phase assets --require-evidence
```
...
```text
feat: add minecraft 1.15 asset profile
```
