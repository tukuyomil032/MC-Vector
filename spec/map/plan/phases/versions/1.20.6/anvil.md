# V-1.20.6-anvil: 1.20.6 saved Anvil adapter
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.20.6 --phase anvil
bun scripts/check-map-version-phase.mjs --version 1.20.6 --phase anvil --require-evidence
```
...
```text
feat: add minecraft 1.20.6 anvil adapter
```
