# V-26.1.2-anvil: 26.1.2 saved Anvil adapter
...
```bash
bun scripts/run-map-version-phase.mjs --version 26.1.2 --phase anvil
bun scripts/check-map-version-phase.mjs --version 26.1.2 --phase anvil --require-evidence
```
...
```text
feat: add minecraft 26.1.2 anvil adapter
```
