# V-26.1.2-paper-snapshot: 26.1.2 Paper snapshot adapter
...
```bash
bun scripts/run-map-version-phase.mjs --version 26.1.2 --phase paper-snapshot
bun scripts/check-map-version-phase.mjs --version 26.1.2 --phase paper-snapshot --require-evidence
```
...
```text
feat: add paper snapshot adapter for minecraft 26.1.2
```
