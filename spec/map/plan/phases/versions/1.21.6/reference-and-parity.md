# V-1.21.6-reference-and-parity: 1.21.6 Java reference and pixel parity
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.21.6 --phase reference-and-parity
bun scripts/check-map-version-phase.mjs --version 1.21.6 --phase reference-and-parity --require-evidence
```
...
```text
test: verify dynmap parity for minecraft 1.21.6
```
