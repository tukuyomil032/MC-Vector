# V-1.21.6-assets: 1.21.6 official assets
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.21.6 --phase assets
bun scripts/check-map-version-phase.mjs --version 1.21.6 --phase assets --require-evidence
```
...
```text
feat: add minecraft 1.21.6 asset profile
```
