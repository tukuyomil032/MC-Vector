# V-1.21.9-real-acceptance: 1.21.9 real Paper/Tauri acceptance
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.21.9 --phase real-acceptance
bun scripts/check-map-version-phase.mjs --version 1.21.9 --phase real-acceptance --require-evidence
```
...
```text
test: record real map acceptance for minecraft 1.21.9
```
