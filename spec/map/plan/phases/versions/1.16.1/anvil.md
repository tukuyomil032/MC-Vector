# V-1.16.1-anvil: 1.16.1 saved Anvil adapter
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.16.1 --phase anvil
bun scripts/check-map-version-phase.mjs --version 1.16.1 --phase anvil --require-evidence
```
...
```text
feat: add minecraft 1.16.1 anvil adapter
```
