# V-1.16.1-reference-and-parity: 1.16.1 Java reference and pixel parity
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.16.1 --phase reference-and-parity
bun scripts/check-map-version-phase.mjs --version 1.16.1 --phase reference-and-parity --require-evidence
```
...
```text
test: verify dynmap parity for minecraft 1.16.1
```
