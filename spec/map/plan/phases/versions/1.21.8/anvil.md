# V-1.21.8-anvil: 1.21.8 saved Anvil adapter
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.21.8 --phase anvil
bun scripts/check-map-version-phase.mjs --version 1.21.8 --phase anvil --require-evidence
```
...
```text
feat: add minecraft 1.21.8 anvil adapter
```
