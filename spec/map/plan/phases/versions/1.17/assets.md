# V-1.17-assets: 1.17 official assets
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.17 --phase assets
bun scripts/check-map-version-phase.mjs --version 1.17 --phase assets --require-evidence
```
...
```text
feat: add minecraft 1.17 asset profile
```
