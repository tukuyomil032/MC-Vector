# V-1.14.1-paper-snapshot: 1.14.1 Paper snapshot adapter
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.14.1 --phase paper-snapshot
bun scripts/check-map-version-phase.mjs --version 1.14.1 --phase paper-snapshot --require-evidence
```
...
```text
feat: add paper snapshot adapter for minecraft 1.14.1
```
