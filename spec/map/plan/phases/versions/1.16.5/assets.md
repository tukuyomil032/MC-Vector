# V-1.16.5-assets: 1.16.5 official assets
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.16.5 --phase assets
bun scripts/check-map-version-phase.mjs --version 1.16.5 --phase assets --require-evidence
```
...
```text
feat: add minecraft 1.16.5 asset profile
```
