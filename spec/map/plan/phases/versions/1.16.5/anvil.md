# V-1.16.5-anvil: 1.16.5 saved Anvil adapter
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.16.5 --phase anvil
bun scripts/check-map-version-phase.mjs --version 1.16.5 --phase anvil --require-evidence
```
...
```text
feat: add minecraft 1.16.5 anvil adapter
```
