# V-1.21.11-reference-and-parity: 1.21.11 Java reference and pixel parity
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.21.11 --phase reference-and-parity
bun scripts/check-map-version-phase.mjs --version 1.21.11 --phase reference-and-parity --require-evidence
```
...
```text
test: verify dynmap parity for minecraft 1.21.11
```
