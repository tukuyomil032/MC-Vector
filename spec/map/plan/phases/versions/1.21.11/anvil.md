# V-1.21.11-anvil: 1.21.11 saved Anvil adapter
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.21.11 --phase anvil
bun scripts/check-map-version-phase.mjs --version 1.21.11 --phase anvil --require-evidence
```
...
```text
feat: add minecraft 1.21.11 anvil adapter
```
