# V-1.20.1-anvil: 1.20.1 saved Anvil adapter
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.20.1 --phase anvil
bun scripts/check-map-version-phase.mjs --version 1.20.1 --phase anvil --require-evidence
```
...
```text
feat: add minecraft 1.20.1 anvil adapter
```
