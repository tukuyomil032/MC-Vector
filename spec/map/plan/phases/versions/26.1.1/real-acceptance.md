# V-26.1.1-real-acceptance: 26.1.1 real Paper/Tauri acceptance
...
```bash
bun scripts/run-map-version-phase.mjs --version 26.1.1 --phase real-acceptance
bun scripts/check-map-version-phase.mjs --version 26.1.1 --phase real-acceptance --require-evidence
```
...
```text
test: record real map acceptance for minecraft 26.1.1
```
