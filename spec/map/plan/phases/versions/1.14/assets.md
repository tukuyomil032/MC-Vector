# V-1.14-assets: 1.14 official assets
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.14 --phase assets
bun scripts/check-map-version-phase.mjs --version 1.14 --phase assets --require-evidence
```
...
```text
feat: add minecraft 1.14 asset profile
```
