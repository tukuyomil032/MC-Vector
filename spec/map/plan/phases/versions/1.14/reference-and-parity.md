# V-1.14-reference-and-parity: 1.14 Java reference and pixel parity
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.14 --phase reference-and-parity
bun scripts/check-map-version-phase.mjs --version 1.14 --phase reference-and-parity --require-evidence
```
...
```text
test: verify dynmap parity for minecraft 1.14
```
