# V-1.14.4-anvil: 1.14.4 saved Anvil adapter
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.14.4 --phase anvil
bun scripts/check-map-version-phase.mjs --version 1.14.4 --phase anvil --require-evidence
```
...
```text
feat: add minecraft 1.14.4 anvil adapter
```
