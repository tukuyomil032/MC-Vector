# V-1.19.4-assets: 1.19.4 official assets
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.19.4 --phase assets
bun scripts/check-map-version-phase.mjs --version 1.19.4 --phase assets --require-evidence
```
...
```text
feat: add minecraft 1.19.4 asset profile
```
