# V-1.19.2-assets: 1.19.2 official assets
...
```bash
bun scripts/run-map-version-phase.mjs --version 1.19.2 --phase assets
bun scripts/check-map-version-phase.mjs --version 1.19.2 --phase assets --require-evidence
```
...
```text
feat: add minecraft 1.19.2 asset profile
```
