...
describe('config-commands', () => {
  ...
  describe('getConfig', () => {
    it('returns value when key exists', async () => {
      ...
      const { getConfig } = await import('@/lib/config-commands');
  ...
  describe('setConfig', () => {
    it('sets value and saves to store', async () => {
      const { setConfig } = await import('@/lib/config-commands');
  ...
  describe('getAllConfig', () => {
    it('converts entries to a Record', async () => {
      ...
      const { getAllConfig } = await import('@/lib/config-commands');
  ...
  describe('getAppSettings', () => {
    it('returns application settings from store', async () => {
      getMock
        ...
        .mockResolvedValueOnce(true);
      const { getAppSettings } = await import('@/lib/config-commands');
  ...
  describe('saveAppSettings', () => {
    it('saves each non-undefined setting and calls save', async () => {
      const { saveAppSettings } = await import('@/lib/config-commands');
  ...
  describe('getServerRoot', () => {
    it('returns appDataDir joined with /servers', async () => {
      const { getServerRoot } = await import('@/lib/config-commands');
