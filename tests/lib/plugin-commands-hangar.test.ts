...
vi.mock('@/lib/adapters/plugin/hangar-adapter', () => ({
...
describe('plugin-commands (Hangar)', () => {
  ...
  describe('searchHangar', () => {
    it('calls searchHangarProjects with limit=25 and returns result/pagination', async () => {
      ...
      const { searchHangar } = await import('@/lib/plugin-commands');
  ...
  describe('getHangarVersions', () => {
    it('includes platform param in URL when platform is provided', async () => {
      ...
      const { getHangarVersions } = await import('@/lib/plugin-commands');
  ...
  describe('resolveHangarDownload', () => {
    it('extracts Hangar camelCase checksum metadata', async () => {
      ...
      const { resolveHangarDownload } = await import('@/lib/plugin-commands');
  ...
  describe('checkHangarCompatibility', () => {
    it('returns compatible=true when matching version exists', async () => {
      ...
      const { checkHangarCompatibility } = await import('@/lib/plugin-commands');
  ...
  describe('getHangarProjectBody', () => {
    it('returns mainPageContent when present', async () => {
      ...
      const { getHangarProjectBody } = await import('@/lib/plugin-commands');
  ...
  describe('installHangarProject', () => {
    it('calls the typed plugin artifact command', async () => {
      const { installHangarProject } = await import('@/lib/plugin-commands');
