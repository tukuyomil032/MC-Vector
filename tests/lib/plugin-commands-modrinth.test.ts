...
vi.mock('@/lib/tauri-api', () => ({ tauriInvoke: tauriInvokeMock, tauriListen: vi.fn() }));
vi.mock('@/lib/adapters/plugin/modrinth-adapter', () => ({
...
describe('plugin-commands (Modrinth)', () => {
  ...
  describe('searchModrinth', () => {
    it('calls searchModrinthProjects and returns hits/total_hits', async () => {
      ...
      const { searchModrinth } = await import('@/lib/plugin-commands');
  ...
  describe('getModrinthVersions', () => {
    it('returns the versions array from the API', async () => {
      ...
      const { getModrinthVersions } = await import('@/lib/plugin-commands');
  ...
  describe('getCompatibleModrinthVersion', () => {
    ...
    it('returns parsed version matching loader and minecraft version', async () => {
      ...
      const { getCompatibleModrinthVersion } = await import('@/lib/plugin-commands');
  ...
  describe('getModrinthVersionById', () => {
    it('returns parsed version when valid payload', async () => {
      ...
      const { getModrinthVersionById } = await import('@/lib/plugin-commands');
  ...
  describe('getModrinthProjectIdentity', () => {
    it('returns id/slug/title when all present', async () => {
      ...
      const { getModrinthProjectIdentity } = await import('@/lib/plugin-commands');
  ...
  describe('getModrinthProjectBody', () => {
    it('returns body when non-empty', async () => {
      ...
      const { getModrinthProjectBody } = await import('@/lib/plugin-commands');
  ...
  describe('installModrinthProject', () => {
    it('calls the typed command with matching fileName', async () => {
      ...
      const { installModrinthProject } = await import('@/lib/plugin-commands');
